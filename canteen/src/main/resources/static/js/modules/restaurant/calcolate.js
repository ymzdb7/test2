...
$(document).ready(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'restaurant/calculate/list',
        datatype: "json",
        colModel: [			
...
var vm = new Vue({
	...
	methods: {
		...
		update: function () {
            ...
            $.get(baseURL + "restaurant/calculate/info/"+id, function(r){
                vm.showList = false;
                vm.title = "修改";
		...
		/*	var boo=confirm('确定要删除选中的记录？');
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: baseURL + "restaurant/calculate/delete",
		...
		saveOrUpdate: function () {
			...
			var url = vm.calculate.id== null ? "restaurant/calculate/save" : "restaurant/calculate/update";
